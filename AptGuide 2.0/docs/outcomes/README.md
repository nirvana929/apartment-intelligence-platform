...
成果文档面向面试、简历和项目复盘，突出产品技术评审、RAG 方案取舍、MVP 成果和可讲述亮点。

| 文档 | 内容 | 状态 |
| --- | --- | --- |
| [13-product-technical-review](../13-product-technical-review.md) | 产品技术评审、方案取舍和风险判断 | existing |
| [20-rag-retrieval-vector-mcp-evaluation-upgrade](../20-rag-retrieval-vector-mcp-evaluation-upgrade.md) | RAG、向量、MCP、评测升级的成果方向 | existing |
| [21-rag-final-implementation-scheme](../21-rag-final-implementation-scheme.md) | 最终 RAG 实施路径和关键取舍 | existing |
| [27-current-implementation-guide](../27-current-implementation-guide.md) | 当前实现成果和代码导览 | active |
