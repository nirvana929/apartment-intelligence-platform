...
![](../assets/e5f5f1b25a3d.png)

### 完整的调用流程，两轮对话加中间执行

Function Calling 的运行时本质上是「两轮对话 + 中间执行」的闭环。

![](../assets/72b20bf50598.png)
