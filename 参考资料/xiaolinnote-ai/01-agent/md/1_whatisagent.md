...
![](../assets/cac11d3e70ba.png)

### Agent 特别在哪？

Agent 就完全不一样了。它有一个核心的运作闭环：**感知 -> 规划 -> 行动 -> 再感知**。

![](../assets/af2cec640fe9.png)
